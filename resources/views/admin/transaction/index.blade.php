...
@section('content')
    <h3 class="h3-title">Quản lý Transactions</h3>
...
//            ],
            searching: false,
            ajax: {
                url: '{{ url('admin/transactionAttribute.data') }}',
                data: function (d) {
            ...
            columns: [
                ...
                {data: 'conversion_count', name: 'conversion_count'},
                {data: 'order_value', name: 'order_value'},
                {data: 'publisher_payout', name: 'publisher_payout'},
            ],
