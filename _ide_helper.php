...
namespace Mbarwick83\Shorty\Facades { 
    ...
    class Shorty {
        ...
        {
            return \Mbarwick83\Shorty\Shorty::shorten($longUrl);
        }
        ...
        {
            return \Mbarwick83\Shorty\Shorty::expand($shortUrl);
        }
         ...
         * @static 
         */ 
        public static function stats($shortUrl)
        {
            return \Mbarwick83\Shorty\Shorty::stats($shortUrl);
        }
...
namespace  { 
    ...
    class Shorty extends \Mbarwick83\Shorty\Facades\Shorty {}
